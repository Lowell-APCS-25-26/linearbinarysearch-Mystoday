public class Sketch {
 ...
 return recursiveLinearSearch(catNumToFind,startIndex+1);
  ...
  public int binarySearch(int catNumToFind){
    int b = 0;
        ...
        while (b <= c) {
            ...
            if (store[d].getCatNum() == catNumToFind) {
                return d;
            }
  ...
  public int recursiveBinarySearch(int catNumToFind, int nLow, int nHigh){
    ...
    else if (store[a].getCatNum() > catNumToFind) {
        return recursiveBinarySearch(catNumToFind, nLow, a - 1);
    }
    else {
        return recursiveBinarySearch(catNumToFind, a + 1, nHigh);
    }
    }
  public void tester(){
